...
/**
 * Convert Cathay Member data to Card
 *
 * @author Le Vinh Nghiem (le.vinhnghiem@gmail.com)
 */
class CathayIssuedCardAdapter implements IssuedCardAdapter
{
    /**
    ...
    public function __construct()
    {
        ...
        if (!$included)
        {
            ...
            $model = ModelPool::getModel('CathayDiagExcl');
                    ...
                    $this->session->add(
                        ...
                        sprintf(
                            ...
                            $this->i18n->membEventNote(
                                ...
                                WEBSITE_ROOT . 'excl-diags/cathay'
                            )
                        )
                    );
                }
        ...
        $helper = DIContainer::resolve(CathayHelper::class);
