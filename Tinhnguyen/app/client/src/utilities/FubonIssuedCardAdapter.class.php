...
/**
 * Convert Fubon Member data to Card
 *
 * @author Le Vinh Nghiem (le.vinhnghiem@gmail.com)
 */
class FubonIssuedCardAdapter implements IssuedCardAdapter
{
    /**
    ...
    public function __construct()
    {
        ...
        if (!$included)
        {
            ...
            $model = ModelPool::getModel('FubonDiagExcl');
        ...
        $helper = DIContainer::resolve(FubonHelper::class);
