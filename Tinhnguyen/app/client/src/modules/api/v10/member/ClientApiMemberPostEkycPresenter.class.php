...
class ClientApiMemberPostEkycPresenter extends ClientApiMemberPresenter
{
     ...
     * @throws
     */
    public function doParserDate($date)
    {
        if(date_create_from_format('d-m-Y', $date)){
            return date_create_from_format('d-m-Y', $date)->format('Y-m-d');
        }elseif(date_create_from_format('d/m/Y', $date)){
            return date_create_from_format('d/m/Y', $date)->format('Y-m-d');
        }elseif(date_create_from_format('j-M-Y', $date)){
            return  date_create_from_format('j-M-Y', $date)->format('Y-m-d');
        }elseif(date_create_from_format('j/M/Y', $date)){
            return  date_create_from_format('jMY', $date)->format('Y-m-d');
        }elseif(date_create_from_format('jMY', $date)){
            return  date_create_from_format('jMY', $date)->format('Y-m-d');
        }elseif(date_create_from_format('j M Y', $date)){
            return  date_create_from_format('j M Y', $date)->format('Y-m-d');
        }elseif(date_create_from_format('d m Y', $date)){
