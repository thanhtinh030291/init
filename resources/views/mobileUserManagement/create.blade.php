...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                {{ Form::open(array('url' => url("admin/user"), 'id' => 'frmCreateStaff', 'files' => true))}}
                <!-- Create account -->
                {{ Form::label('name',__('message.name'), array('class' => 'labelas')) }}<span class="text-danger">*</span>
                {{ Form::text('name', old('name'), ['class' => 'form-control', 'placeholder'=>__('message.enter_staff_name'),  'required']) }}<br>
                ...
                {{ Form::password('password',  ['type' => 'password','class' => 'form-control', 'placeholder'=>__('message.enter_staff_password'), 'required']) }}<br>
